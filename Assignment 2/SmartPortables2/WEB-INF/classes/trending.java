...
public class trending extends HttpServlet {
	...
	public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>Smartwatch|SmartPortal</title>");
		...
		out.println("<li class=''><a href='smartwatch'>Smart Watches</a></li>");
		out.println("<li class=''><a href='speaker'>Speakers</a></li>");
		out.println("<li class=''><a href='headphone'>Headphones</a></li>");
		out.println("<li class=''><a href='smartphones'>Smart Phones</a></li>");
		out.println("<li class=''><a href='laptops'>Laptops</a></li>");
		out.println("<li class=''><div class='dropdown'><a>External Storage</a>");
		out.println("<div class='dropdown-content'>");
		out.println("<a href='harddrives'>Hard Drives</a>");
		out.println("<a href='flashdrives'>Flash Drives</a>");
		out.println("<a href='memorycard'>Memory cards</a>");
		out.println("</div>");
		out.println("</div>");
		out.println("</li>");
...
out.println("</article>");
		...
		out.println("<ul>");
		out.println("<li class=''><a href='home'>Home</a></li>");
		out.println("<li class='start selected'><a href='smartwatch'>Smart Watches</a></li>");
		out.println("<li class=''><a href='speaker'>Speakers</a></li>");
		out.println("<li class=''><a href='headphone'>Headphones</a></li>");
		out.println("<li class=''><a href='smartphones'>Smart Phones</a></li>");
		out.println("<li class=''><a href='laptops'>Laptops</a></li>");
		...
		out.println("<p>Smart Portables Ltd </p>");
		out.println("</div>");
		out.println("</footer>");
		out.println("</div>");
		out.println("</body>");
