...
Run the tomcat server which containes the folder "SmartPortables4"- My assignment #5
...
Run the script given by the professor for the python file and retrive the data for the DealsMatches text file
...
The DealsMatches text file will be amtched with the products in the MySQL database and it will be shown in the web application as shown in the demo
