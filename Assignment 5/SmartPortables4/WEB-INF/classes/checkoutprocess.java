	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  pw.println("<div id='container'>");
		...
		for (Map.Entry<String, List<Integer>> entry : items.entrySet()) {
			...
			Order order = new Order(userid, orderno, key, values.get(0), values.get(1), deliverydate, s, address, city, state, zip, country, fullname, cardNumber);//, orderamt);
		...
		pw.println("<h3><br /><br />HI Your Order No " + orderno+ ", has been Placed Succesfully. The order is placed on " + deliverydate + " and will be delivered in 3 days </h3><br /><br />");
		...
		pw.println("<ul>");
		pw.println("<li><a href='phones'>Smart Phones</a></li>");
